...
# try breaking up code and converting it into a function

try:
    htmlLink = requests.get("https://www.paulaschoice.com/ingredient-dictionary").text
    # page = urlopen(url)
except:
    print("Error opening url")

soup = BeautifulSoup(htmlLink, 'lxml')
